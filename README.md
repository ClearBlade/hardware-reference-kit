...
> - Platform URL (Platform on which your `ClearBlade Platform System` is running, ex https://platform.clearblade.com)
> - System Key (For your `ClearBlade Platform System`)
> - System Secret (`ClearBlade Platform System`)
> - User Email (from Step 1)
> - User Password (from Step 1)
> - Edge Name (autogenerated by default)
> 
